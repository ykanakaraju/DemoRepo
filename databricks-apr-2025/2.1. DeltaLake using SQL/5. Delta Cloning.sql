...
DESC EXTENDED users_clone_shallow_v1

-- COMMAND ----------

-- MAGIC %fs ls dbfs:/user/hive/warehouse/demodb.db/users_clone_shallow_v1

-- COMMAND ----------

DESC HISTORY users_clone_shallow_v1

-- COMMAND ----------

UPDATE users_clone_shallow_v1 SET age = age * 10
...
RESTORE TABLE users_clone_shallow_v1 TO VERSION AS OF 0
...
DESCRIBE HISTORY users_clone_shallow_v1
